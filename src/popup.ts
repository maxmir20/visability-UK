// TypeScript popup implementation
...
class PopupManager {
  ...
  private async init(): Promise<void> {
    try {
      ...
      if (!activeTab.url || !activeTab.url.includes('linkedin.com')) {
        this.showError('This extension only works on LinkedIn pages.');
        return;
      }
  ...
  private showResults(currentCompany: string, results: SearchResults): void {
